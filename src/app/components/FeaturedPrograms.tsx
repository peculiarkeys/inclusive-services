...
const golfCenterImgs = import.meta.glob("../../assets/*") as Record<string, string>;
const furnituresImgs = import.meta.glob("../../assets/*") as Record<string, string>;
const modernCityJahiImgs = import.meta.glob("../../assets/*") as Record<string, string>;
const asokoroImgs = import.meta.glob("../../assets/*") as Record<string, string>;
...
const categories = [
  ...
  { id: "architectural", label: "Architectural Plan" },
  { id: "renovation", label: "Crisis Intervention" },
...
const featuredprogramsList = [
  {
    ...
    description: "A comprehensive renovation and furniture installation program.",
  ...
  {
    title: "Architectural Plan Estate",
  ...
  },
  {
    ...
    description: "A luxury residential development program in Asokoro, Abuja.",
    image: getFirstImage(asokoroImgs),
    link: "/works/asokoro-program",
    category: "residential",
...
export function Featuredprograms() {
  ...
  const filteredprograms = activeCategory === "all"
    ...
    : featuredprogramsList.filter((p) => p.category === activeCategory);
      ...
      <div className="max-w-[1320px] mx-auto">
        <AnimatedSection className="text-center mb-12">
          ...
          <p className="text-white/60 max-w-2xl mx-auto font-sans" style={{ fontSize: "16px", lineHeight: "24px" }}>
            A curated showcase of our counseling excellence, child welfare capability, and support quality across our most ambitious recent works.
          </p>
        </AnimatedSection>
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-6 md:p-10 flex flex-col justify-end transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 ease-out">
                      ...
                      <h4 className="text-white text-2xl md:text-3xl lg:text-4xl  tracking-tight mb-2">
                        {program.title}
                      </h4>
