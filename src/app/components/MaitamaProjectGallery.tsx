...
interface MaitamaProjectGalleryProps {
  columns?: 2 | 3;
}

export function MaitamaProjectGallery({ columns = 3 }: MaitamaProjectGalleryProps = {}) {
      ...
      <div className="max-w-[1320px] mx-auto">
        <AnimatedSection className="text-center mb-16">
          <h2 className="text-[#111111]" style={{ fontSize: "clamp(36px, 4vw, 56px)", fontWeight: 500, lineHeight: "1.1", letterSpacing: "-1px" }}>
            8 Bedrooms Private Residential Development
          </h2>
          <p className="text-[#546478] mt-4 max-w-2xl mx-auto text-lg font-sans">
            <strong>Location:</strong> Maitama, Abuja<br />
            <strong>Scope:</strong> Turnkey Project (Design, Build & Furnish)
          </p>
        </AnimatedSection>
