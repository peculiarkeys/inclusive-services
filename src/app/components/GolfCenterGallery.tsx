...
const rawImages = import.meta.glob("../../assets/golf_center/*.{jpeg,jpg,png,webp}", {
  eager: true,
  import: "default",
...
interface GolfCenterGalleryProps {
  columns?: 2 | 3;
}

export function GolfCenterGallery({ columns = 3 }: GolfCenterGalleryProps = {}) {
      ...
      <div className="max-w-[1320px] mx-auto">
        <AnimatedSection className="text-center mb-16">
          <h2 className="text-[#111111]" style={{ fontSize: "clamp(36px, 4vw, 56px)", fontWeight: 500, lineHeight: "1.1", letterSpacing: "-1px" }}>
            Golf Center Development
          </h2>
          <p className="text-[#546478] mt-4 max-w-2xl mx-auto text-lg">
            Showcasing our precision work on the Golf Center facility.
          </p>
        </AnimatedSection>
