...
interface MaitamaprogramGalleryProps {
  columns?: 2 | 3;
}

export function MaitamaprogramGallery({ columns = 3 }: MaitamaprogramGalleryProps = {}) {
      ...
      <div className="max-w-[1320px] mx-auto">
        <AnimatedSection className="text-center mb-16">
          ...
          <p className="text-[#546478] mt-4 max-w-2xl mx-auto text-lg font-sans">
            ...
            <strong>Scope:</strong> Community program (Plan, Build & Furnish)
          </p>
        </AnimatedSection>
