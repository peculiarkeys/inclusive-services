...
interface AsokoroprogramGalleryProps {
  columns?: 2 | 3;
}

export function AsokoroprogramGallery({ columns = 3 }: AsokoroprogramGalleryProps = {}) {
      ...
      <div className="max-w-[1320px] mx-auto">
        <AnimatedSection className="text-center mb-16">
          ...
          <p className="text-[#546478] mt-4 max-w-2xl mx-auto text-lg font-sans">
            A visual showcase of the luxury residential development in Asokoro, Abuja.
          </p>
        </AnimatedSection>
