...
interface FurnituresAndFurnishingGalleryProps {
  columns?: 2 | 3;
}

export function FurnituresAndFurnishingGallery({ columns = 3 }: FurnituresAndFurnishingGalleryProps = {}) {
      ...
      <div className="max-w-[1320px] mx-auto">
        <AnimatedSection className="text-center mb-16">
          ...
          <p className="text-[#546478] mt-4 max-w-2xl mx-auto text-lg">
            A visual showcase of our bespoke furniture and furnishing projects.
          </p>
        </AnimatedSection>
          ...
          {visibleImages.map((src, index) => (
            <AnimatedSection key={index} delay={(index % 6) * 0.1}>
              <div className="break-inside-avoid relative group rounded-2xl overflow-hidden bg-gray-200">
                <ImageWithFallback 
                  src={src} 
                  alt={`Furnishing project ${index + 1}`} 
