...
const img1 = projectImages[8] || "";
const img2 = projectImages[9] || "";
const img3 = projectImages[10] || "";

const stats = [
  { value: "98%", label: "Complete client satisfaction" },
  { value: "200+", label: "Completed successful projects" },
  { value: "150+", label: "Certified construction experts" },
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
            <div className="lg:w-[20%]">
              <AnimatedSection>
                <div className="flex items-center gap-2 text-sm font-medium text-[#111111]">
                  <span className="w-2 h-2 rounded-full bg-[#111111]"></span> About Obembe
                </div>
              </AnimatedSection>
            </div>
            ...
            <div className="lg:w-[80%]">
              <AnimatedSection delay={0.1}>
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-medium text-[#111111] mb-16 leading-[1.4] max-w-4xl">
                  We are passionate about delivering superior construction solutions, empowering you to achieve your structural goals with confidence.
                </h2>
      ...
      <div className="py-20 px-6 md:px-[60px]">
        <div className="max-w-[1320px] mx-auto">
          ...
          <AnimatedSection className="mb-16 flex flex-col lg:flex-row gap-8 justify-between items-start lg:items-end">
            <h2 className="text-[#111111] font-medium leading-[1.1] max-w-xl" style={{ fontSize: "clamp(40px, 5vw, 56px)", letterSpacing: "-1px" }}>
              Make building easy, simplify your project
            </h2>
            <p className="text-gray-500 max-w-md text-[15px] leading-relaxed font-sans">
              Our firm manages residential or commercial portfolios. Our system integrates the latest technology and engineering to help you make smarter construction decisions with ease.
            </p>
          </AnimatedSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:auto-rows-[280px]">
            ...
            <AnimatedSection delay={0.1} className="md:col-span-2 rounded-[32px] overflow-hidden relative h-[280px] md:h-auto">
              <ImageWithFallback src={img1} alt="Construction meeting" className="w-full h-full object-cover transition-transform duration-700 hover:scale-105" />
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2} className="bg-[#1A2024] rounded-[32px] p-8 text-white flex flex-col justify-center h-[280px] md:h-auto">
              <h3 className="text-4xl font-medium mb-4 text-white">Vision</h3>
            ...
            <AnimatedSection delay={0.3} className="md:col-span-1 md:row-span-2 rounded-[32px] overflow-hidden relative h-[400px] md:h-auto">
              <ImageWithFallback src={img2} alt="Building structure" className="w-full h-full object-cover transition-transform duration-700 hover:scale-105" />
            </AnimatedSection>

            {/* Bottom Left: Purple Block -> Our accent block (col-span-2) */}
            <AnimatedSection delay={0.4} className="md:col-span-2 bg-[#d16c49] rounded-[32px] p-8 md:p-10 text-white flex flex-col justify-end h-[280px] md:h-auto">
              <h3 className="text-5xl font-medium mb-4">Mission</h3>
